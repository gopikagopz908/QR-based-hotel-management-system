...
//   return (
//     <div className="container mx-auto mt-20 px-4 sm:px-6 pb-20">
//       <h1 className="text-4xl sm:text-5xl font-bold mb-20 text-center text-red-800 font-poppins">
//         🧾 Your Order Summary
//       </h1>
...
//             <div
//               key={item.id}
//               className="bg-white rounded-3xl shadow-xl p-6 sm:p-10 flex flex-col md:flex-row gap-6 md:gap-8 items-center justify-between relative transition-all duration-300 hover:scale-[1.01]"
//             >
//               <img
//                 src={item.image}
//                 alt={item.name}
//                 className="w-full sm:w-40 md:w-52 h-auto object-cover rounded-2xl border-2 border-gray-200 shadow-sm"
//               />

//               <div className="flex-1 space-y-2 text-center md:text-left">
//                 <h2 className="text-2xl sm:text-3xl font-bold text-gray-800">{item.name}</h2>
//                 <p className="text-gray-500 text-base sm:text-lg">{item.description}</p>
//                 <p className="text-3xl sm:text-4xl text-red-600 font-semibold">
//                   ₹{item.price}
//                 </p>
//               </div>
...
//                 <button
//                   onClick={() => decreaseQty(item.id)}
//                   className="w-10 sm:w-12 h-10 sm:h-12 rounded-full bg-gray-200 text-2xl sm:text-3xl font-bold hover:bg-gray-300 transition"
//                 >
//                   −
//                 </button>
//                 <span className="text-xl sm:text-2xl font-semibold">{item.quantity}</span>
//                 <button
//                   onClick={() => increaseQty(item.id)}
//                   className="w-10 sm:w-12 h-10 sm:h-12 rounded-full bg-gray-200 text-2xl sm:text-3xl font-bold hover:bg-gray-300 transition"
//                 >
...
//               <div className="absolute bottom-4 md:bottom-5 right-4 md:right-6 text-xl sm:text-2xl md:text-3xl font-bold text-black">
//                 Total ₹{item.price * item.quantity}
//               </div>
//             </div>
//           ))}

//           <div className="mt-14 flex flex-col sm:flex-row justify-between items-center bg-gray-100 rounded-2xl shadow-md px-6 sm:px-8 py-6 w-full max-w-5xl mx-auto gap-4 sm:gap-0">
//             <div className="text-2xl sm:text-3xl font-bold text-red-700">
//               Total: ₹{total}
//             </div>
//             <button
//               onClick={() => alert("Proceeding to payment...")}
//               className="bg-red-800 text-white text-lg sm:text-xl font-semibold px-6 sm:px-8 py-4 sm:py-5 rounded-full hover:bg-red-700 transition"
//             >
//               Pay Now
//             </button>
//           </div>
...
//         <button
//           onClick={() => navigate("/menu")}
//           className="bg-black text-white px-8 sm:px-10 py-3 sm:py-4 rounded-full text-xl sm:text-2xl font-semibold hover:bg-red-700 transition"
//         >
//           Back to Menu
//         </button>
//       </div>
